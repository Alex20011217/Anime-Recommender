...
# Pickle the cosine similarity matrices
with open('TC_anime_desc_cosine_sim.pkl', 'wb') as f:
    pickle.dump(TC_Anime_desc_cosine_sim, f)

with open('TC_anime_genre_cosine_sim.pkl', 'wb') as f:
    pickle.dump(TC_Anime_genre_cosine_sim, f)

# Pickle the index mapping Series
with open('TC_anime_desc_index_sim.pkl', 'wb') as f:
    pickle.dump(TC_Anime_desc_index_sim, f)

with open('TC_anime_genre_index_sim.pkl', 'wb') as f:
    pickle.dump(TC_Anime_genre_index_sim, f)
...
# # BOW
# In this code, we have replaced TfidfVectorizer with CountVectorizer to create a BOW representation. The resulting desc_count_matrix will contain counts of each word's occurrence in the anime descriptions instead of TF-IDF values.
